...
var G = (t, e, r) => (r = t != null ? fi(yi(t)) : {}, bi(
...
var Xr = I((pl, Vt) => {
  var Qe = process || {}, Hr = Qe.argv || [], Xe = Qe.env || {}, xi = !(Xe.NO_COLOR || Hr.includes("--no-color")) && (!!Xe.FORCE_COLOR || Hr.
  includes("--color") || Qe.platform === "win32" || (Qe.stdout || {}).isTTY && Xe.TERM !== "dumb" || !!Xe.CI), wi = /* @__PURE__ */ i((t, e, r = t) => (n) => {
    let s = "" + n, o = s.indexOf(e, t.length);
    return ~o ? t + _i(s, e, r, o) + e : t + s + e;
  }, "formatter"), _i = /* @__PURE__ */ i((t, e, r, n) => {
    let s = "", o = 0;
    do
      s += t.substring(o, n) + r, o = n + e.length, n = t.indexOf(e, o);
    while (~n);
    return s + t.substring(o);
  }, "replaceClose"), Yr = /* @__PURE__ */ i((t = xi) => {
    let e = t ? wi : () => String;
    return {
      isColorSupported: t,
...
var Jt = I((Kt) => {
  ...
  var ee = Ne(), A = st(), Mi = /* @__PURE__ */ i((t, e) => {
    let r;
    switch (t.code) {
...
var Yt = I((T) => {
  ...
  var qi = /* @__PURE__ */ i((t) => ({ status: "dirty", value: t }), "DIRTY");
  T.DIRTY = qi;
  var Wi = /* @__PURE__ */ i((t) => ({ status: "valid", value: t }), "OK");
  T.OK = Wi;
...
t declare it");
  ...
  d.date = void 0;
  var at = ot(), y = wn(), u = Yt(), h = Ne(), m = st(), D = class {
    static {
...
onent})+$", Xt, oa = /^(?:(?:25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])\.){3}(?:25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])$/, ia = /^(?:(?:25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])\.){3}(?:25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])\/(3[0-2]|[12]?[0-9])$/,
  ...
  B(t.unwrap()) : t instanceof me ? B(t._def.innerType) : [], "getDiscriminator"), dt = class t extends x {
    static {
    ...
    return t ? J.create().superRefine((n, s) => {
      ...
      if (c instanceof Promise)
        return c.then((l) => {
          var p, f;
          if (!l) {
            let v = kn(e, n), w = (f = (p = v.fatal) !== null && p !== void 0 ? p : r) !== null && f !== void 0 ? f : !0;
...
adonly";
  ...
  }) => jn((r) => r instanceof t, e), "instanceOfType");
  d.instanceof = ga;
  var Pn = K.create;
  d.string = Pn;
  var An = te.create;
  ...
  var ja = O.create;
  d.object = ja;
  var Pa = O.strictCreate;
  d.strictObject = Pa;
  var Aa = ae.create;
  d.union = Aa;
  var Oa = dt.create;
  d.discriminatedUnion = Oa;
  var Ra = ce.create;
  d.intersection = Ra;
  var Na = V.create;
  d.tuple = Na;
  ...
  var za = Ue.create;
  d.pipeline = za;
  var Ka = /* @__PURE__ */ i(() => Pn().optional(), "ostring");
  d.ostring = Ka;
  var Ja = /* @__PURE__ */ i(() => An().optional(), "onumber");
  d.onumber = Ja;
  var Ha = /* @__PURE__ */ i(() => On().optional(), "oboolean");
  d.oboolean = Ha;
  d.coerce = {
...
var as = I((Ep, is) => {
  var je = process.platform === "win32" || process.env.OSTYPE === "cygwin" || process.env.OSTYPE === "msys", ts = N("path"), pc = je ? ";" :
  ":", rs = es(), ns = /* @__PURE__ */ i((t) => Object.assign(new Error(`not found: ${t}`), { code: "ENOENT" }), "getNotFoundError"), ss = /* @__PURE__ */ i(
  (t, e) => {
    let r = e.colon || pc, n = t.match(/\//) || je && t.match(/\\/) ? [""] : [
    ...
    let { pathEnv: n, pathExt: s, pathExtExe: o } = ss(t, e), a = [], c = /* @__PURE__ */ i((p) => new Promise((f, v) => {
      if (p === n.length)
        return e.all && a.length ? f(a) : v(ns(t));
      let w = n[p], k = /^".*"$/.test(w) ? w.slice(1, -1) : w, j = ts.join(k, t), S = !k && /^\.[\\\/]/.test(t) ? t.slice(0, 2) + j : j;
      f(l(S, p, 0));
    }), "step"), l = /* @__PURE__ */ i((p, f, v) => new Promise((w, k) => {
      if (v === s.length)
        return w(c(f + 1));
      let j = s[v];
      rs(p + j, { pathExt: o }, (S, C) => {
        if (!S && C)
          if (e.all)
            a.push(p + j);
          else
...
var Ts = I((Up, ks) => {
  "use strict";
  var _c = N("path"), ws = fs(), _s = ms(), kc = xs(), Tc = process.platform === "win32", Ic = /\.(?:com|exe)$/i, Sc = /node_modules[\\/].bin[\\/][^\\/]+\.cmd$/i;
  function Ec(t) {
    t.file = ws(t);
    let e = t.file && kc(t.file);
    return e ? (t.args.unshift(t.file), t.command = e, ws(t)) : t.file;
  }
  i(Ec, "detectShebang");
  function Cc(t) {
    if (!Tc)
    ...
    if (t.options.forceShell || r) {
      let n = Sc.test(e);
      t.command = _c.normalize(t.command), t.command = _s.command(t.command), t.args = t.args.map((o) => _s.argument(o, n));
...
var no = I((ym, ro) => {
  "use strict";
  var { PassThrough: Pd } = N("stream");
  ro.exports = function() {
    var t = [], e = new Pd({ objectMode: !0 });
...
var Ao = I((ph, Po) => {
  ...
  Po.exports = /* @__PURE__ */ i(function(e, r = au(e)) {
    let [n = "", ...s] = e;
      ...
      return new Promise(function(p, f) {
        var v = /* @__PURE__ */ i(function(k) {
          ...
          t(j, o).then(function(S) {
            ...
            else k < a ? w(k, S, null) : f(S);
          });
        }, "wrappedFetch");
        function w(k, j, S) {
          var C = typeof c == "function" ? c(k, j, S) : c;
          setTimeout(function() {
            v(++k);
          }, C);
        }
...
var en = "telemetry-notification-date", be = console, tn = /* @__PURE__ */ i(async () => {
  await Qr.get(en, null) || (Qr.set(en, Date.now()), be.log(), be.log(
    `${et.default.magenta(
      et.default.bold("attention")
    )} => Storybook now collects completely anonymous telemetry regarding usage.`
  ), be.log("This information is used to shape Storybook's roadmap and prioritize features."), be.log(
    "You can learn more, including how to opt-out if you'd not like to participate in this anonymous program, by visiting the following URL:"
  ), be.log(et.default.cyan("https://storybook.js.org/telemetry")), be.log());
}, "notify");
...
async function ln(t, e) {
  return !t || !Wt(t, "file") ? null : await Ai(t, e);
}
    ...
    for (let o of r)
      switch (o) {
        ...
        case "install-metadata": {
          for (let a of Object.keys(qt)) {
            let c = a.endsWith("/") ? "dir" : "file";
            if (await Wt(Q.join(s, a), c)) {
              let l = qt[a], p = l === "yarn" ? Oi(a) ? "yarn" : "yarn@berry" : l;
...
async function Ai(t, e) {
  try {
    let r = JSON.parse(await pn.readFile(t, "utf8")), n, s = Pi(r);
    if (s) {
...
i(Ai, "handlePackageManager");
function Oi(t) {
  return t.endsWith(".yarn_integrity");
}
i(Oi, "isMetadataYarnClassic");
...
import { sep as _u } from "node:path";
...
var Rc = /* @__PURE__ */ i(({
  ...
  let o = t instanceof URL ? As(t) : t, a = Ve.resolve(o), c = [];
  ...
  let n = e instanceof URL ? As(e) : e;
  t.push(Ve.resolve(r, n, ".."));
}, "applyExecPath"), Os = /* @__PURE__ */ i(({ env: t = gt.env, ...e } = {}) => {
  t = { ...t };
  let r = yt({ env: t });
...
var vt = /* @__PURE__ */ new WeakMap(), Rs = /* @__PURE__ */ i((t, e = {}) => {
...
import { constants as qc } from "node:os";
...
o !== void 0 ? `failed with exit code ${o}` : "failed", "getErrorPrefix"), Fe = /* @__PURE__ */ i(({
  ...
  isCanceled: p,
  killed: f,
  parsed: { options: { timeout: v, cwd: w = Xc.cwd() } }
}) => {
  o = o === null ? void 0 : o, s = s === null ? void 0 : s;
  let k = s === void 0 ? void 0 : Ls[s].description, j = n && n.code, C = `Command ${Qc({ timedOut: l, timeout: v, errorCode: j, signal: s, signalDescription: k,
  exitCode: o, isCanceled: p })}: ${a}`, Oe = Object.prototype.toString.call(n) === "[object Error]", ve = Oe ? `${C}
${n.message}` : C, X = [ve, e, t].filter(Boolean).join(`
`);
  return Oe ? (n.originalMessage = n.message, n.message = X) : n = new Error(X), n.shortMessage = ve, n.command = a, n.escapedCommand = c, n.
  exitCode = o, n.signal = s, n.signalDescription = k, n.stdout = t, n.stderr = e, n.cwd = w, r !== void 0 && (n.all = r), "bufferedData" in
  n && delete n.bufferedData, n.failed = !0, n.timedOut = !!l, n.isCanceled = p, n.killed = f && !l, n;
}, "makeError");

// node_modules/execa/lib/stdio.js
var bt = ["stdin", "stdout", "stderr"], ed = /* @__PURE__ */ i((t) => bt.some((e) => t[e] !== void 0), "hasAlias"), Us = /* @__PURE__ */ i((t) => {
  if (!t)
    return;
  let { stdio: e } = t;
  if (e === void 0)
...
var xt = /* @__PURE__ */ i((t) => !!t && typeof t == "object" && typeof t.removeListener == "function" && typeof t.emit == "function" && typeof t.
...
unction", "processOk"), hr = Symbol.for("signal-exit emitter"), yr = globalThis, td = Object.defineProperty.bind(Object), gr = class {
...
}), "signalExitWrap"), vr = class extends wt {
  static {
  ...
  /* c8 ignore start */
  #i = xr.platform === "win32" ? "SIGINT" : "SIGHUP";
  /* c8 ignore stop */
  #t = new gr();
  #e;
  #s;
...
}, "validateTimeout"), Ws = /* @__PURE__ */ i(async (t, { cleanup: e, detached: r }, n) => {
  if (!e || r)
    return n;
  let s = $s(() => {
    t.kill();
...
// node_modules/execa/lib/pipe.js
var pd = /* @__PURE__ */ i((t) => t instanceof ld && typeof t.then == "function", "isExecaChildProcess"), _r = /* @__PURE__ */ i((t, e, r) => {
  if (typeof r == "string")
  ...
  t.stdout !== null && (t.pipeStdout = _r.bind(void 0, t, "stdout")), t.stderr !== null && (t.pipeStderr = _r.bind(void 0, t, "stderr")), t.
  all !== void 0 && (t.pipeAll = _r.bind(void 0, t, "all"));
}, "addPipeMethods");

// node_modules/execa/lib/stream.js
import { createReadStream as Ad, readFileSync as Od } from "node:fs";
...
maxBuffer: l = Number.POSITIVE_INFINITY } = {}) => {
  ...
  try {
    for await (let f of t) {
      let v = hd(f), w = r[v](f, p);
      Js({ convertedChunk: w, state: p, getSize: n, truncateChunk: s, addChunk: o, maxBuffer: l });
    }
...
var yd = /* @__PURE__ */ i(() => ({ contents: new ArrayBuffer(0) }), "initArrayBuffer"), gd = /* @__PURE__ */ i((t) => vd.encode(t), "useTex\
tEncoder"), vd = new TextEncoder(), Hs = /* @__PURE__ */ i((t) => new Uint8Array(t), "useUint8Array"), Ys = /* @__PURE__ */ i((t) => new Uint8Array(
t.buffer, t.byteOffset, t.byteLength), "useUint8ArrayWithOffset"), bd = /* @__PURE__ */ i((t, e) => t.slice(0, e), "truncateArrayBufferChunk"),
xd = /* @__PURE__ */ i((t, { contents: e, length: r }, n) => {
  let s = eo() ? _d(e, n) : wd(e, n);
  return new Uint8Array(s).set(t, r), s;
}, "addArrayBufferChunk"), wd = /* @__PURE__ */ i((t, e) => {
  if (e <= t.byteLength)
    return t;
  let r = new ArrayBuffer(Qs(e));
  return new Uint8Array(r).set(new Uint8Array(t), 0), r;
}, "resizeArrayBufferSlow"), _d = /* @__PURE__ */ i((t, e) => {
...
}, "validateInputOptions"), Nd = /* @__PURE__ */ i(({ input: t, inputFile: e }) => typeof e != "string" ? t : (oo(t), Od(e)), "getInputSync"),
io = /* @__PURE__ */ i((t) => {
  let e = Nd(t);
  if (_t(e))
    throw new TypeError("The `input` option cannot be a stream in sync mode");
  return e;
}, "handleInputSync"), Zd = /* @__PURE__ */ i(({ input: t, inputFile: e }) => typeof e != "string" ? t : (oo(t), Ad(e)), "getInput"), ao = /* @__PURE__ */ i(
(t, e) => {
  let r = Zd(e);
...
"string" || Vd.test(t) ? t : `"${t.replaceAll('"', '\\"')}"`, "escapeArg"), Ar = /* @__PURE__ */ i((t, e) => mo(t, e).join(" "), "joinComman\
d"), Or = /* @__PURE__ */ i((t, e) => mo(t, e).map((r) => Fd(r)).join(" "), "getEscapedCommand"), ho = / +/g, yo = /* @__PURE__ */ i((t) => {
  let e = [];
...
import { debuglog as qd } from "node:util";
import Wd from "node:process";
var go = qd("execa").enabled, Ct = /* @__PURE__ */ i((t, e) => String(t).padStart(e, "0"), "padField"), Gd = /* @__PURE__ */ i(() => {
...
var Jd = 1e3 * 1e3 * 100, Hd = /* @__PURE__ */ i(({ env: t, extendEnv: e, preferLocal: r, localDir: n, execPath: s }) => {
  let o = e ? { ...jt.env, ...t } : t;
  return r ? Os({ env: o, cwd: n, execPath: s }) : o;
}, "getEnv"), xo = /* @__PURE__ */ i((t, e, r = {}) => {
  let n = bo.default._parse(t, e, r);
  return t = n.command, e = n.args, r = n.options, r = {
    ...
    extendEnv: !0,
    preferLocal: !1,
    localDir: r.cwd || jt.cwd(),
    execPath: jt.execPath,
    encoding: "utf8",
    reject: !0,
    cleanup: !0,
    all: !1,
    ...
    verbose: go,
    ...r
  }, r.env = Hd(r), r.stdio = Us(r), jt.platform === "win32" && Kd.basename(t, ".exe") === "cmd" && e.unshift("/q"), { file: t, args: e, options: r,
  parsed: n };
}, "handleArguments"), qe = /* @__PURE__ */ i((t, e, r) => typeof e != "string" && !zd.isBuffer(e) ? r === void 0 ? void 0 : "" : t.stripFinalNewline ?
lr(e) : e, "handleOutput");
function wo(t, e, r) {
  let n = xo(t, e, r), s = Ar(t, e), o = Or(t, e);
  Nr(o, n.options), qs(n.options);
  let a;
  try {
    a = Zr.spawn(n.file, n.args, n.options);
  } catch (k) {
    let j = new Zr.ChildProcess(), S = Promise.reject(Fe({
      error: k,
      stdout: "",
      stderr: "",
      all: "",
  ...
  let c = lo(a), l = Bs(a, n.options, c), p = Ws(a, n.options, l), f = { isCanceled: !1 };
  a.kill = Vs.bind(null, a.kill.bind(a)), a.cancel = Fs.bind(null, a, f);
  let w = Ns(/* @__PURE__ */ i(async () => {
    let [{ error: k, exitCode: j, signal: S, timedOut: C }, Oe, ve, X] = await uo(a, n.options, p), Je = qe(n.options, Oe), He = qe(n.options,
    ve), _ = qe(n.options, X);
    if (k || j !== 0 || S !== null) {
      let P = Fe({
        error: k,
  ...
  return ao(a, n.options), a.all = co(a, n.options), Gs(a), Pr(a, w), a;
}
i(wo, "execa");
function Yd(t, e, r) {
  let n = xo(t, e, r), s = Ar(t, e), o = Or(t, e);
...
import { readFile as Eo, readdir as Co, rm as jo, writeFile as su } from "node:fs/promises";
...
var At = class {
  ...
  constructor(e = {}) {
    this.prefix = (e.ns || e.prefix || "") + "-", this.hash_alg = e.hash_alg || "md5", this.cache_dir = e.basePath || We(ou(), eu(15).toString(
    "base64").replace(/\//g, "-")), this.ttl = e.ttl || 0, Io(this.hash_alg), Dr(this.cache_dir, { recursive: !0 });
  }
  generateHash(e) {
    return We(this.cache_dir, this.prefix + Io(this.hash_alg).update(e).digest("hex"));
  }
  isExpired(e, r) {
  ...
  async remove(e) {
    await jo(this.generateHash(e), { force: !0 });
  }
  removeSync(e) {
  ...
  async clear() {
    ...
    await Promise.all(
      e.filter((r) => r.startsWith(this.prefix)).map((r) => jo(We(this.cache_dir, r), { force: !0 }))
    );
  }
  clearSync() {
    ru(this.cache_dir).filter((e) => e.startsWith(this.prefix)).forEach((e) => So(We(this.cache_dir, e), { force: !0 }));
  }
  async getAll() {
    let e = Date.now(), r = await Co(this.cache_dir);
    return (await Promise.all(
      r.filter((s) => s.startsWith(this.prefix)).map((s) => Eo(We(this.cache_dir, s), "utf8"))
...
import Oo, { promises as Th } from "node:fs";
...
function Ur(t, {
  ...
  lu(r), e = fu(e);
  let s = n ? Oo.statSync : Oo.lstatSync;
  for (let o of t)
    try {
...
import Ph, { promises as Ah } from "node:fs";

// ../node_modules/pkg-dir/node_modules/find-up/index.js
var hu = /* @__PURE__ */ i((t) => t instanceof URL ? mu(t) : t, "toPath"), yu = Symbol("findUpStop");
function gu(t, e = {}) {
  let r = Ot.resolve(hu(e.cwd) || ""), { root: n } = Ot.parse(r), s = e.stopAt || n, o = e.limit || Number.POSITIVE_INFINITY, a = [t].flat(),
  c = /* @__PURE__ */ i((p) => {
    if (typeof t != "function")
      return Ur(a, p);
    let f = t(p.cwd);
  ...
  for (; ; ) {
    let p = c({ ...e, cwd: r });
    if (p === yu || (p && l.push(Ot.resolve(r, p)), r === s || l.length >= o))
      break;
    r = Ot.dirname(r);
  }
  return l;
...
function Zo({ cwd: t } = {}) {
  ...
  return e && vu.dirname(e);
}
i(Zo, "packageDirectorySync");

// node_modules/find-cache-dir/index.js
var { env: $r, cwd: xu } = bu, Mo = /* @__PURE__ */ i((t) => {
  try {
...
var Pu = [
  ...
  "angular",
  "ember"
], Au = ["builder-webpack5", "builder-vite"];
function qo(t, e) {
...
async function Wo(t) {
  ...
  if (!r)
    return {};
  let n = qo(r, Au), s = qo(r, Pu), o = Ou(e), a = typeof t.framework == "object" ? t.framework.options : {};
  return {
    framework: {
      name: o,
      options: a
...
var Ko = {
  ...
  if (r)
    return r;
  if (!zo(qr(t, "package.json")))
    return;
  if (JSON.parse(
    Nu(qr(t, "package.json"), { encoding: "utf8" })
  )?.workspaces)
    return "Workspaces";
}, "getMonorepoType");
...
"").replace(/\/preset$/, ""), "sanitizeAddonName"), qu = /* @__PURE__ */ i(async ({
  packageJsonPath: t,
  packageJson: e,
  mainConfig: r
}) => {
  let n = await Fn(), s = {
    ...
    ...e?.devDependencies,
    ...e?.peerDependencies
  }, a = Object.keys(o).find((_) => !!Yo[_]);
  if (a) {
    let { version: _ } = await Zt(a);
    s.metaFramework = {
      name: Yo[a],
      packageName: a,
      version: _
  ...
  let c = [
    ...
    (_) => c.find((P) => _.includes(P))
  );
  s.testPackages = Object.fromEntries(
    await Promise.all(
      l.map(async (_) => [_, (await Zt(_))?.version])
    )
  ), s.hasRouterPackage = Go(e);
  let p = Jo();
  p && (s.monorepo = p);
  try {
    let _ = await Gt({ cwd: Lu() });
    _ && (s.packageManager = {
      type: _.name,
      version: _.version,
      agent: _.agent
  ...
  r.addons && r.addons.forEach((_) => {
    let P, Ye;
    typeof _ == "string" ? P = Xo(_) : (_.name.includes("addon-essentials") && (Ye = _.options), P = Xo(_.name)), w[P] = {
      options: Ye,
      version: void 0
    };
  });
  ...
  k && (w.chromatic = {
    ...
    versionSpecifier: k,
    options: void 0
  }), (await Fr(w)).forEach(({ name: _, version: P }) => {
    w[_].version = P;
  });
  let S = Object.keys(w), C = Object.keys(o).filter((_) => _.includes("storybook") && !S.includes(_)).reduce((_, P) => ({
    ..._,
    [P]: { version: void 0 }
  }), {});
  (await Fr(C)).forEach(({ name: _, version: P }) => {
    C[_].version = P;
  });
  let ve = !!o["eslint-plugin-storybook"], X = $u(e);
  try {
    let { previewConfig: _ } = X;
    if (_) {
      let P = await Bu(_), Ye = !!(P.getFieldNode(["globals"]) || P.getFieldNode(["globalTypes"]));
...
i(Wu, "getPackageJsonDetails");
var Mt, Qo = /* @__PURE__ */ i(async (t) => {
  if (Mt)
    return Mt;
  let { packageJson: e, packageJsonPath: r } = await Wu(), n = (t || Uu(
    String(e?.scripts?.storybook || ""),
    "-c",
    "--config-dir"
  )) ?? ".storybook", s = await Vu({ configDir: n }).catch(() => {
  });
  return Mt = await qu({ mainConfig: s, packageJson: e, packageJsonPath: r }), Mt;
...
// ../node_modules/nanoid/index.js
var Gu = 128, ge, Ae, zu = /* @__PURE__ */ i((t) => {
  !ge || ge.length < t ? (ge = Buffer.allocUnsafe(t * Gu), ni(ge), Ae = 0) : Ae + t > ge.length && (ni(ge), Ae = 0), Ae += t;
}, "fillPool");
...
// src/telemetry/index.ts
var Ev = /* @__PURE__ */ i((t) => t.startsWith("example-button--") || t.startsWith("example-header--") || t.startsWith("example-page--"), "i\
sExampleStoryId"), Cv = /* @__PURE__ */ i(async (t, e = {}, r = {}) => {
...
export {
  ...
  Re as cleanPaths,
  qu as computeStorybookMetadata,
  sl as getPrecedingUpgrade,
  Qo as getStorybookMetadata,
  Ev as isExampleStoryId,
