...
var m = (o, t, e, r) => {
  if (t && typeof t == "object" || typeof t == "function")
    for (let i of p(t))
      !u.call(o, i) && i !== e && y(o, i, { get: () => t[i], enumerable: !(r = l(t, i)) || r.enumerable });
  return o;
};
var a = (o, t, e) => (e = o != null ? c(v(o)) : {}, m(
...
// src/bin/index.ts
var d = require("node:child_process"), k = require("node:fs"), b = require("node:path");
...
if (["dev", "build", "index"].includes(s[0]))
  ...
  if (s[0] === "init") {
    ...
    e ? JSON.parse((0, k.readFileSync)(e, "utf-8")).version === n["create-storybook"] && (o = [
      "node",
      (0, b.join)((0, b.dirname)(e), "bin", "index.cjs"),
      ...s.slice(1)
    ]) : o = ["npx", "--yes", `create-storybook@${n.storybook}`, ...s.slice(1)];
  } else {
    let e;
    try {
    ...
    e ? JSON.parse((0, k.readFileSync)(e, "utf-8")).version === n["@storybook/cli"] && (o = ["node", (0, b.join)((0, b.dirname)(e), "bin", "\
index.cjs"), ...s]) : o = ["npx", "--yes", `@storybook/cli@${n.storybook}`, ...s];
  }
  o || (console.error("Could not run storybook cli, please report this as a bug"), process.exit(1)), (0, d.spawn)(o[0], o.slice(1), { stdio: "\
